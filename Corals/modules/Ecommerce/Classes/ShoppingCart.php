...
use Corals\Modules\Ecommerce\Contracts\ShoppingCartContract;
...
class ShoppingCart implements ShoppingCartContract
{
     ...
     * @param $value
     *
     * @throws \Corals\Modules\Ecommerce\Exceptions\InvalidPrice
     * @throws \Corals\Modules\Ecommerce\Exceptions\InvalidQuantity
     *
     * @return CartItem|null
     */
