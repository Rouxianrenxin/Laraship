...
<div class="select-section {{ $class = str_random().'_setting' }}">
    <div class="table-responsive">
        <table id="values-table" width="100%"
            ...
            <thead>
            <tr>
                <th width="15%">@lang('Ecommerce::labels.attribute.order')</th>
                <th width="35%">@lang('Ecommerce::labels.attribute.value')</th>
                <th width="50%">@lang('Ecommerce::labels.attribute.display')</th>
                <th></th>
            </tr>
            </thead>
            <tbody>
    ...
    <span class="help-block">
                            @lang('Ecommerce::labels.attribute.add_new_option')
                        </span>
</div>
