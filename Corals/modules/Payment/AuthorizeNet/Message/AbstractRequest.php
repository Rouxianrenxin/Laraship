...
abstract class AbstractRequest extends BaseAbstractRequest
{
    ...
    {
        return $this->getParameter('chargeData');
    }
    ...
    public function setChargeData($value)
    {
        return $this->setParameter('chargeData', $value);
    }
        ...
        if ($amount !== null) {
            if (!is_float($amount) &&
                ...
                throw new InvalidRequestException(
                    trans('AuthorizeNet::exception.invalid_request_exception_specify_amount')
                );
            }
