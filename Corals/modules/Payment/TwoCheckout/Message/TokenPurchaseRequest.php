...
use Corals\Modules\Payment\TwoCheckout\Message\AbstractRequest;
...
class TokenPurchaseRequest extends AbstractRequest
{
    ...
    public function getData()
    {
        ...
        $data['billingAddr'] = $this->getBillingAddr();
        if ($this->getCard()) {
    ...
    public function sendData($data)
    {
        ...
        return new TokenPurchaseResponse($this, json_decode($response->getBody()->getContents(), true));
