...
{
    protected $liveEndpoint = 'https://www.omise.com/api/sales/refund_invoice';
    protected $testEndpoint = 'https://sandbox.omise.com/api/sales/refund_invoice';
    ...
    public function getData()
    {
        ...
        // see https://www.omise.com/documentation/api/sales/refund-invoice
        if ($this->getCategory()) {
