 ...
 */
abstract class AbstractRestRequest extends \Corals\Modules\Payment\Common\Message\AbstractRequest
{
    ...
    public function sendData($data)
    {
        ...
        try {
            ...
            throw new InvalidResponseException(
                trans('PayPal::exception.error_communicating', ['message' => $e->getMessage()]),
                $e->getCode()
            );
        }
    }
