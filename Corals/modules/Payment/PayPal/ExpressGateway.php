...
class ExpressGateway extends ProGateway
{
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\PayPal\Message\ExpressAuthorizeRequest', $parameters);
    }

    public function completeAuthorize(array $parameters = array())
    {
        return $this->createRequest('\Corals\Modules\Payment\PayPal\Message\ExpressCompleteAuthorizeRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\PayPal\Message\ExpressCompletePurchaseRequest', $parameters);
    }

    public function void(array $parameters = array())
    {
        return $this->createRequest('\Corals\Modules\Payment\PayPal\Message\ExpressVoidRequest', $parameters);
    }

    public function fetchCheckout(array $parameters = array())
    {
        return $this->createRequest('\Corals\Modules\Payment\PayPal\Message\ExpressFetchCheckoutRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\PayPal\Message\ExpressTransactionSearchRequest', $parameters);
    }

    public function order(array $parameters = array())
    {
        return $this->createRequest('\Corals\Modules\Payment\PayPal\Message\ExpressOrderRequest', $parameters);
    }

    public function completeOrder(array $parameters = array())
    {
        return $this->createRequest('\Corals\Modules\Payment\PayPal\Message\ExpressCompleteOrderRequest', $parameters);
    }
