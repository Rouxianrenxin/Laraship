 ...
 * @link https://securionpay.com/docs/api#create_refund
 */
class RefundRequest extends AbstractRequest
{
     ...
     *
     * From the {@link https://securionpay.com/docs/api#create_refund SecurionPay docs}:
     ...
     * Whether to refund the application fee associated with a charge.
     *
     * From the {@link https://securionpay.com/docs/connect/destination-charges#issuing-refunds SecurionPay docs}:
