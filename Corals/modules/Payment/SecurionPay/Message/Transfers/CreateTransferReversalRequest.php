...
/**
 * SecurionPay Reverse Transfer Request (Connect only).
 */

namespace Corals\Modules\Payment\SecurionPay\Message\Transfers;

use Corals\Modules\Payment\SecurionPay\Message\RefundRequest;

/**
 * SecurionPay Transfer Reversal Request.
 *
 ...
 * </code>
 *
 * @link https://securionpay.com/docs/api#create_transfer_reversal
 */
