...
/**
 * SecurionPay Transfer Request (Connect only).
 */
...
use Corals\Modules\Payment\SecurionPay\Message\AuthorizeRequest;

/**
 * SecurionPay Transfer Request.
 *
 ...
 *
 * <code>
 *   // Create the transfer object when moving funds between SecurionPay accounts
 ...
 * @link https://securionpay.com/docs/connect/charges-transfers
 */
class CreateTransferRequest extends AuthorizeRequest
{
    ...
    public function getData()
    {
        ...
        if ($this->getTransferGroup()) {
            ...
            throw new InvalidRequestException(trans('SecurionPay::exception.source_transaction_required'));
        }
