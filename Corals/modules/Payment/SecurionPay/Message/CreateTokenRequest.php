 ...
 *
 * @link https://securionpay.com/docs/api#create_card_token
 */
class CreateTokenRequest extends AbstractRequest
{
     ...
     * @return \Corals\Modules\Payment\Common\Message\AbstractRequest|\Corals\Modules\Payment\SecurionPay\Message\CreateTokenRequest
     */
    ...
    public function getData()
    {
        ...
        if ($this->getParameter('customer')) {
            ...
            throw new InvalidRequestException(trans('SecurionPay::exception.must_pass_card'));
        }
