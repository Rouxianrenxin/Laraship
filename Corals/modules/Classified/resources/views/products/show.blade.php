...
@section('content_header')
    @component('components.content_header')
        ...
        @slot('breadcrumb')
            {{ Breadcrumbs::render('classified_product_show') }}
        @endslot
    @endcomponent
@endsection
                ...
                <div class="table-responsive">
                    <table class="table color-table info-table table table-hover table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <td>{!! $product->presenter()['plain_name'] !!}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><b>{!! $product->presenter()['status'] !!}</b></td>
                        </tr>
                        <tr>
                            <td>@lang('Ecommerce::attributes.product.categories')</td>
                            <td><b>{!! $product->presenter()['categories']  !!}</b></td>
                        </tr>
                        <tr>
                            <td>@lang('Ecommerce::attributes.product.tags')</td>
                            <td><b>{!!  $product->presenter()['tags']  !!}</b></td>
                        </tr>
                        <tr>
