<section class="container padding-bottom-2x">
    <div class="row">
        @if(!($topSellersProducts = \Shop::getTopSellers())->isEmpty())
            <div class="col-md-4 col-sm-6">
                <div class="widget widget-featured-products">
                    <h3 class="widget-title">@lang('corals-ecommerce-ultimate::labels.partial.top_sellers')</h3>
                    <!-- Entry-->
        ...
        @if(!($newArrivalsProducts = \Shop::getNewArrivals())->isEmpty())
            <div class="col-md-4 col-sm-6">
                <div class="widget widget-featured-products">
                    <h3 class="widget-title">@lang('corals-ecommerce-ultimate::labels.partial.new_arrivals')</h3>
                    <!-- Entry-->
        ...
        @if(!($bestRatedProducts = \Shop::getBestRated())->isEmpty())
            <div class="col-md-4 col-sm-6">
                <div class="widget widget-featured-products">
                    <h3 class="widget-title">@lang('corals-ecommerce-ultimate::labels.partial.best_rated')</h3>
                    <!-- Entry-->
