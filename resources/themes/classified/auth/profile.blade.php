        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong>@lang('corals-classified-master::auth.change_image')</strong></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="actions my-3">
                        <span class="btn btn-info btn-file">@lang('corals-classified-master::auth.browse_files')
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary m-r-10 m-l-10"
                            id="Save">@lang('corals-classified-master::auth.save',['title'=>''])</button>
                    <button type="button" class="btn btn-default"
                            data-dismiss="modal">@lang('corals-classified-master::auth.close')</button>
                </div>
            </div>
        </div>
    </div>
