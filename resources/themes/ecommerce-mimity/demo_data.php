...
if (\Schema::hasTable('posts')
    ...
    \Corals\Modules\CMS\Models\Page::updateOrCreate(['slug' => 'home', 'type' => 'page',],
        array(
            ...
            'content' => '<div id="slider">@slider(mimity-slider)</div>',
            'published' => 1,
    ...
    \Corals\Modules\CMS\Models\Page::updateOrCreate(['slug' => 'about-us', 'type' => 'page'],
        array(
            ...
            <div class="col-md-6 mb-3 mb-md-0">
              <img src="/assets/themes/ecommerce-mimity/img/about-us.jpg" alt="About Us" class="w-100">
            </div>
            <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-6 mb-3 mb-md-0 order-md-2">
              <img src="/assets/themes/ecommerce-mimity/img/our-purpose.jpg" alt="Our Purpose" class="w-100">
            </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <div class="media">
                <img class="rounded-circle mr-3" src="/assets/themes/ecommerce-mimity/img/serve.jpg" width="64" height="64" alt="We Serve">
            ...
            <div class="col-md-6 mb-3">
              <div class="media">
                <img class="rounded-circle mr-3" src="/assets/themes/ecommerce-mimity/img/run.jpg" width="64" height="64" alt="We Run">
                <div class="media-body">
                  <h5>We Run</h5>
            ...
            <div class="col-md-6 mb-3">
              <div class="media">
                <img class="rounded-circle mr-3" src="/assets/themes/ecommerce-mimity/img/adapt.jpg" width="64" height="64" alt="We Adapt">
                <div class="media-body">
                  <h5>We Adapt</h5>
            ...
            <div class="col-md-6 mb-3">
              <div class="media">
                <img class="rounded-circle mr-3" src="/assets/themes/ecommerce-mimity/img/commit.jpg" width="64" height="64" alt="We Commit">
                <div class="media-body">
                  <h5>We Commit</h5>
...
if (\Schema::hasTable('cms_blocks') && class_exists(\Corals\Modules\CMS\Models\Block::class)) {
    $block = \Corals\Modules\CMS\Models\Block::updateOrCreate(['name' => 'E-Commerce Features', 'key' => 'e-commerce-features'], [
