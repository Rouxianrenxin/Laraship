...
if (class_exists(\Corals\Modules\Marketplace\Models\Product::class) && \Schema::hasTable('marketplace_products')) {
    ...
    /**
     * ///////////////////////// Categories
     * $mobilesCat = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Mobiles', 'slug' => 'mobiles'], [
     * 'is_featured' => 1,
     * ]);
     *
     * $tabletsCat = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Tablets', 'slug' => 'tablets'], [
     * 'is_featured' => 1,
     * ]);
     *
     * $accessoriesCat = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Accessories', 'slug' => 'accessories'], [
     * 'is_featured' => 1,
     * ]);
     *
     * $headphones = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Headphones', 'slug' => 'headphones'], [
     * 'is_featured' => 0,
     * 'parent_id' => $accessoriesCat->id
     * ]);
     *
     * $cases = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Cases', 'slug' => 'cases'], [
     * 'is_featured' => 0,
     * 'parent_id' => $accessoriesCat->id
     * ]);
     *
     * $chargers = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Chargers', 'slug' => 'chargers'], [
     * 'is_featured' => 0,
     * 'parent_id' => $accessoriesCat->id
     * ]);
     *
     * $memCards = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Memory Cards', 'slug' => 'mem-cards'], [
     * 'is_featured' => 0,
     * 'parent_id' => $accessoriesCat->id
     * ]);
     *
     * $screenProtector = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Screen Protector', 'slug' => 'screen-protector'], [
     * 'is_featured' => 0,
     * 'parent_id' => $accessoriesCat->id
     * ]);
     *
     ...
     * 'model_type' => 'Corals\\Modules\\Marketplace\\Models\\Category',
     * 'collection_name' => 'marketplace-category-thumbnail',
     * 'name' => 'accessories',
     ...
     *
     * foreach ($tags as $tag) {
     * $tagsObjects->push(\Corals\Modules\Marketplace\Models\Tag::updateOrCreate(['slug' => $tag['slug']], $tag));
     * }
     * ///////////////////////// Brands
     *
     * $samsungBrand = \Corals\Modules\Marketplace\Models\Brand::updateOrCreate(['name' => 'Samsung', 'slug' => 'samsung-mobile'], [
     * 'is_featured' => 1,
     * ]);
     *
     * $appleBrand = \Corals\Modules\Marketplace\Models\Brand::updateOrCreate(['name' => 'Apple', 'slug' => 'apple-mobile'], [
     * 'is_featured' => 1,
     * ]);
     *
     * $huaweiBrand = \Corals\Modules\Marketplace\Models\Brand::updateOrCreate(['name' => 'Huawei', 'slug' => 'huawei-mobile'], [
     * 'is_featured' => 1,
     * ]);
     *
     * $htcBrand = \Corals\Modules\Marketplace\Models\Brand::updateOrCreate(['name' => 'HTC', 'slug' => 'htc-mobile'], [
     * 'is_featured' => 1,
     * ]);
     *
     * $lgBrand = \Corals\Modules\Marketplace\Models\Brand::updateOrCreate(['name' => 'LG', 'slug' => 'lg-mobile'], [
     * 'is_featured' => 1,
     * ]);
     *
     * $brandsMedia = array(
     * array(
     * 'model_id' => $lgBrand->id,
     * 'model_type' => 'Corals\\Modules\\Marketplace\\Models\\Brand',
     * 'collection_name' => 'marketplace-brand-thumbnail',
     * 'name' => 'lg_logo',
     ...
     * }
     * ///////////////////////// Attributes
     * $memoryAttr = \Corals\Modules\Marketplace\Models\Attribute::updateOrCreate(['type' => 'select', 'label' => 'Memory'], [
     * 'display_order' => 0,
     * 'use_as_filter' => 1,
     * 'required' => 1,
     * ]);
     *
     * $storageAttr = \Corals\Modules\Marketplace\Models\Attribute::updateOrCreate(['type' => 'select', 'label' => 'Storage'], [
     * 'display_order' => 1,
     * 'use_as_filter' => 1,
     * 'required' => 1,
     * ]);
     *
     * $colorAttr = \Corals\Modules\Marketplace\Models\Attribute::updateOrCreate(['type' => 'select', 'label' => 'Color'], [
     * 'display_order' => 2,
     * 'use_as_filter' => 1,
     * 'required' => 1,
     * ]);
     *
     * $wirelessAttr = \Corals\Modules\Marketplace\Models\Attribute::updateOrCreate(['type' => 'multi_values', 'label' => 'Wireless Technology'], [
     * 'display_order' => 3,
     * 'use_as_filter' => 0,
     * 'required' => 1,
     * ]);
     ...
     * try {
     * $attrOptionsObjects->push(\Corals\Modules\Marketplace\Models\AttributeOption::updateOrCreate([
...
//    $samsungCat = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Samsung', 'slug' => 'samsung'], [
//        'parent_id' => $mobileCat->id,
//        'is_featured' => 1,
//    ]);
//
//    $appleCat = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Apple', 'slug' => 'apple'], [
//        'parent_id' => $mobileCat->id,
//        'is_featured' => 1,
//    ]);
//
//    $huaweiCat = \Corals\Modules\Marketplace\Models\Category::updateOrCreate(['name' => 'Huawei', 'slug' => 'huawei'], [
//        'parent_id' => $mobileCat->id,
//        'is_featured' => 1,
//    ]);
//    $marketplaceMedia = [
...
//    ];
//
//    foreach ($marketplaceMedia as $media) {
//        try {
//            \Spatie\MediaLibrary\Media::updateOrCreate([
//                'model_id' => $media['model_id'], 'model_type' => $media['model_type']
//            ], $media);
...
//    );
//
//    $s9 = \Corals\Modules\Marketplace\Models\Product::updateOrCreate(['name' => $s9['name']], $s9);
//
//    \Corals\Modules\Marketplace\Models\SKU::updateOrCreate(['product_id' => $s9->id], [
//        'regular_price' => 799,
//        'code' => 'SG-S9',
...
//    );
//
//    $note8 = \Corals\Modules\Marketplace\Models\Product::updateOrCreate(['name' => $note8['name']], $note8);
//    \Corals\Modules\Marketplace\Models\SKU::updateOrCreate(['product_id' => $note8->id], [
//        'regular_price' => 949,
//        'code' => 'SN-8',
//        'inventory' => 'infinite', 'status' => 'active'
//    ]);
...
//        'is_featured' => 1,
//    );
//    $mate10 = \Corals\Modules\Marketplace\Models\Product::updateOrCreate(['name' => $mate10['name']], $mate10);
//    \Corals\Modules\Marketplace\Models\SKU::updateOrCreate(['product_id' => $mate10->id], [
//        'regular_price' => 755,
//        'code' => 'HM-10',
//        'inventory' => 'infinite', 'status' => 'active'
//    ]);
...
//    );
//
//    $iphone8 = \Corals\Modules\Marketplace\Models\Product::updateOrCreate(['name' => $iphone8['name']], $iphone8);
//    \Corals\Modules\Marketplace\Models\SKU::updateOrCreate(['product_id' => $iphone8->id], [
//        'regular_price' => 999,
//        'code' => 'Ai-8',
//        'inventory' => 'infinite', 'status' => 'active'
//    ]);
...
//    );
//
//    $iphone7 = \Corals\Modules\Marketplace\Models\Product::updateOrCreate(['name' => $iphone7['name']], $iphone7);
//    \Corals\Modules\Marketplace\Models\SKU::updateOrCreate(['product_id' => $iphone7->id], [
//        'regular_price' => 785,
//        'code' => 'Ai-7',
//        'inventory' => 'infinite', 'status' => 'active'
//    ]);
...
//        array(
//            'model_id' => $s9->id,
//            'model_type' => 'Corals\\Modules\\Marketplace\\Models\\Product',
//            'collection_name' => 'marketplace-product-gallery',
...
if (class_exists(\Corals\Modules\Slider\Models\Slider::class) && \Schema::hasTable('sliders')) {
    ...
    $slides = array(
        array(
            'name' => 'E-First Slide',
            'content' => '/assets/themes/marketplace-master/img/slider/marketplace-1.png',
            'slider_id' => $slider->id,
            'status' => 'active',
        ),
        array(
            'name' => 'E-Second Slide',
            'content' => '/assets/themes/marketplace-master/img/slider/marketplace-2.png',
            'slider_id' => $slider->id,
            'status' => 'active',
        )
    );
