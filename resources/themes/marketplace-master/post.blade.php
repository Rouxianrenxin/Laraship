        ...
        <div class="row {{ !in_array($blog->template, ['right', 'left'])?'justify-content-center':'' }}">
            <div class="{{ !in_array($blog->template, ['right', 'left'])?'col-lg-10':'col-xl-9 col-lg-8' }} {{ $blog->template =='left' ? 'order-lg-2':'' }}">
                ...
                <div class="single-post-meta">
                    <div class="column">
                        <div class="meta-link">{{trans('corals-marketplace-master::labels.post.show_author',['name' => $item->author->name])}}</div>
                        ...
                        @endif
                        <div class="meta-link">
                            <span>@lang('corals-marketplace-master::labels.post.category')</span>
