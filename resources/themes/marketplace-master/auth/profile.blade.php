                    ...
                    <li class="nav-item">
                        <a href="#profile" class="nav-link {{ $active_tab=="profile"? 'active':'' }}"
                           role="tab" data-toggle="tab">
                            @lang('corals-marketplace-master::labels.auth.profile')
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane {{ $active_tab=="profile"? 'active':'' }}" id="profile" role="tabpanel">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-pills mt-2">
                                    <li class="nav-item"><a href="#edit_profile" class="nav-link active"
                                                            data-toggle="tab"
                                                            aria-expanded="false">
                                            <i class="fa fa-pencil"></i> @lang('corals-marketplace-master::labels.auth.edit_profile')
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#profile_addresses" class="nav-link" data-toggle="tab"><i
                                                    class="fa fa-map-marker"></i>
                                            @lang('corals-marketplace-master::labels.auth.addresses')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#reset_password" class="nav-link" data-toggle="tab"><i
                                                    class="fa fa-lock"></i>
                                            @lang('corals-marketplace-master::labels.auth.auth_password')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#notification_preferences" class="nav-link" data-toggle="tab"><i
                                                    class="fa fa-bell-o"></i>
                                            @lang('corals-marketplace-master::labels.auth.notification_preferences')</a>
                                    </li>
                                </ul>
                                <div class="tab-content py-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="text-center">
                                                    ...
                                                    <small class="">@lang('corals-marketplace-master::labels.auth.click_pic_update')</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="notification_preferences">
                                        ...
                                        @empty
                                            <h4>@lang('corals-marketplace-master::labels.auth.no_notification')</h4>
                                        @endforelse
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    {!! CoralsForm::formButtons(trans('corals-marketplace-master::labels.auth.save',['title' => $title_singular]),[],['href'=>url('dashboard')]) !!}
                                </div>
                                {!! Form::close() !!}
                            </div>
                        </div>
