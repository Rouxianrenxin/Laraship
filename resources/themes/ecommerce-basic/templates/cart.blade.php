            ...
            <div class="shopping-cart-footer">
                <div class="column">
                    <div class="column"><a class="btn btn-outline-secondary" href="{{ url('shop') }}"><i
                                    class="icon-arrow-left"></i>&nbsp; @lang('corals-ecommerce-basic::labels.template.cart.back_shopping')</a></div>
                </div>
                <div class="column text-lg">@lang('corals-ecommerce-basic::labels.template.cart.subtotal')
                    <span class="text-medium" id="total">
                        {{ ShoppingCart::subTotal() }}
                    </span>
                    <a class="btn btn-success" href="{{ url('checkout') }}">@lang('corals-ecommerce-basic::labels.template.cart.checkout')</a>
                </div>
            </div>
            {{--<div class="shopping-cart-footer">--}}
            {{--</div>--}}
